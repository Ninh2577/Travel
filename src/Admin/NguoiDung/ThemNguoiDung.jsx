...
const FormDisabledDemo = ({ visible, onCancel, onBack }) => {
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <Form.Item label="Vai Trò">
                <Select>
                  <Select.Option value="vaiTro">Nhân Viên </Select.Option>
                  <Select.Option value="vaiTro">Khách Hàng </Select.Option>
                  <Select.Option value="vaiTro">Admin </Select.Option>
                </Select>
              </Form.Item>
            </div>
